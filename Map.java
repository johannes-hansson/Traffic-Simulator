...
public class Map {
    ...
    public Map() {
        ...
        MockNode ch4 = new MockNode(new double[]{450, 450}, 50, true);
        ...
        MockNode ch22 = new MockNode(new double[]{550, 400}, 50, false);
